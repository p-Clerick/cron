...
<body>
    <div id="container">
        <form name="login" action="auth" method="post">
            ...
            <div id="lower">
                <input id="signin_submit" type="submit" tabindex="4" value="Вход">
                <a href="/guest"><input class="guest" tabindex="5" value="Свободный доступ" readonly></a>
            </div>
        </form>
    </div>
</body>
