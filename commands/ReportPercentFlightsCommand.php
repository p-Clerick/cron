		...
		if ($countDate==0){
 		...
 		for ($cd=0; $cd < $countDate; $cd++) {
			...
			if ($countSql==0) {
				...
				//шукаемо кінцеві
				$endStops=ReportEndStops::model()->findAll(array(
					'condition'=> 'date = :date',
