...
class NoconnectionController extends CController
{
	...
	protected function findOrders ($from, $to) {
		...
		$result = $this->fillOrderByDate($orders, $from, $to);
		return $result;
	}
	 ...
	 */
	protected function fillOrderByDate ($records, $from, $to) {
		$result = array();
